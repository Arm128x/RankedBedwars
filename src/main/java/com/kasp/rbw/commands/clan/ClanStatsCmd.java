...
public class ClanStatsCmd extends Command {
    ...
    public void execute(String[] args, Guild guild, Member sender, TextChannel channel, Message msg) {
        ...
        if (new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/theme.png").exists()) {
            ...
            try {
                ...
                BufferedImage image;
                if (new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/" + clan.getName() + "/theme.png").exists()) {
                    image = ImageIO.read(new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/" + clan.getName() + "/theme.png").toURI().toURL());
                }
                else {
                    image = ImageIO.read(new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/theme.png").toURI().toURL());
                }

                BufferedImage icon;
                if (new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/" + clan.getName() + "/icon.png").exists()) {
                    icon = ImageIO.read(new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/" + clan.getName() + "/icon.png").toURI().toURL());
                }
                else {
                    icon = ImageIO.read(new File(RBW.getInstance().getDataFolder() + "/RankedBot/clans/icon.png").toURI().toURL());
                }
